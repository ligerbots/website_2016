            ...
            <div class="row bottom-margin">
              ...
              <div class="col-sm-10 col-sm-offset-1 col-xs-12">
                <div class="row spr-first-section">
                  <div class="big-sprs">
                    <embed class="sprs-image" src="/images/sponsor-logos/sponsor_page_full_2024b.svg" />
                  </div>
                  <div class="small-sprs text-margins">
                    <embed class="sprs-image" src="/images/sponsor-logos/sponsor_page_narrow_2024b.svg" />
                  </div>
                <div>
              </div>
            </div>
