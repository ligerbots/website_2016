        ...
        <div class="page-body">
          ...
          <div class="row side-margins">
            <div class="col-md-6 bottom-margin">
              <div class="panel panel-orange bottom-margin">
                ...
                <div id="blog-panel" class="panel-body">
                  ...
                  <div class="side-margins">
                    ...
                    <div class="read-more bottom-padding">
                      <?php echo '<a href="' . get_permalink( $blog ) . '">'; ?><img src="/images/read_more.svg"/></a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6 bottom-margin">
              <div class="panel panel-blue bottom-margin">
                <div class="panel-heading index-heading">
          ...
          <div class="row wide-side-margins">
            <div class="panel panel-brag">
              <img src="/images/team_photo_2016.jpg"/>
            </div>
            <div style="text-align:center;">
              <div class="label-blue">WPI Competition 2016</div>
            </div>
          </div>
